...
public class Avaliador implements Serializable {
	...
	public void setConfirmacaoAvaliadors(List<ConfirmacaoAvaliador> confirmacaoAvaliadors) {
		this.confirmacaoAvaliadors = confirmacaoAvaliadors;
	}

	public ConfirmacaoAvaliador addConfirmacaoAvaliador(ConfirmacaoAvaliador confirmacaoAvaliador) {
	...
	public ConfirmacaoAvaliador removeConfirmacaoAvaliador(ConfirmacaoAvaliador confirmacaoAvaliador) {
