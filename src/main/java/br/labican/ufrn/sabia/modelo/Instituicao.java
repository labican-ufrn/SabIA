...
public class Instituicao implements Serializable {
	...
	public void setContatoInstituicaos(List<ContatoInstituicao> contatoInstituicaos) {
		this.contatoInstituicaos = contatoInstituicaos;
	}

	public ContatoInstituicao addContatoInstituicao(ContatoInstituicao contatoInstituicao) {
	...
	public ContatoInstituicao removeContatoInstituicao(ContatoInstituicao contatoInstituicao) {
