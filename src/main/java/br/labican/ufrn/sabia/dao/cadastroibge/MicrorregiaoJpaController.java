...
public class MicrorregiaoJpaController implements Serializable {
    ...
    public void edit(Microrregiao microrregiao)
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException(
                        "The microrregiao with id " + id + " no longer exists.",
                        enfe);
            }
    ...
    public List<Microrregiao> findMicrorregiaoEntities(int maxResults,
            int firstResult) {
        return findMicrorregiaoEntities(false, maxResults, firstResult);
    }

    private List<Microrregiao> findMicrorregiaoEntities(boolean all,
