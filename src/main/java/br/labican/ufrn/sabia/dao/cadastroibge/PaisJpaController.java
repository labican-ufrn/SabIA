...
public class PaisJpaController implements Serializable {
    ...
    public void edit(Pais pais) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findPais(id) == null) {
                    throw new NonexistentEntityException("The pais with id "
                            + id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The pais with id " + id
    ...
    private List<Pais> findPaisEntities(boolean all, int maxResults,
            int firstResult) {
